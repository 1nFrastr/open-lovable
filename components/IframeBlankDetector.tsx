...
export default function IframeBlankDetector({
  ...
  }, [iframeRef, sandboxUrl, maxRetries, retryDelay, onRetry]);

  const scheduleCheck = useCallback(() => {
    if (checkTimeoutRef.current) {
      clearTimeout(checkTimeoutRef.current);
    }
    checkTimeoutRef.current = setTimeout(checkForBlankContent, checkDelay);
  }, [checkForBlankContent, checkDelay]);
  ...
  }, [sandboxUrl, enabled, scheduleCheck]);
